            ...
            <div className={"flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg w-full border shadow-xl xl:p-8"} style={{borderColor: mainColor}}>
                ...
                <ul role="list" className="mb-8 space-y-2 text-left">
                    {services.map(service => {
                        ...
                        return (
                            <li className="flex items-center space-x-3" key={service.text}>
                                {svg}
                ...
                <a href="/contact" className={"text-white hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center "} style={{background: mainColor}}>Nous Contacter</a>
            </div>
        </Reveal>
    </>
  )
