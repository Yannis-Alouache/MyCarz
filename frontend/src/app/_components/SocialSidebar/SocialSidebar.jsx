        ...
        <div className="block lg:hidden mx-auto fixed inset-x-0 bottom-2 z-50 px-5">
            <div className="bg-[#EEEEEE] border-2 shadow-md border-gray rounded-full py-2 px-4">
                <ul className="flex justify-between items-center">
                    ...
                    <li>
                        <a href="https://api.whatsapp.com/send?phone=+33620081250" className=" transition-all ease-in-out duration-300 hover:opacity-50" target="_blank"><Image src={Whatsapp} className="w-[25px] h-[25px]" /></a>
                    </li>
                </ul>
